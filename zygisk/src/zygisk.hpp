...
struct Api {
  ...
  //
  // The root companion process is ABI aware; that is, when calling this method
  // from a 32-bit process, you will be connected to a 32-bit companion process,
  ...
  // methods or in the root companion process (assuming that you sent the fd
  ...
  // memory. For matching ELFs loaded in memory, replace function `symbol` with
