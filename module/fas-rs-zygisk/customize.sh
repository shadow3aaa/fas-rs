...
local_echo "updateJson=https://github.com/shadow3aaa/fas-rs/raw/master/update/update_zygisk.json" "updateJson=https://github.com/shadow3aaa/fas-rs/raw/master/update/update_zygisk_en.json" >>$MODPATH/module.prop
