...
- ### **`powersave` / `balance` / `performance` / `fast` Description:**
  ...
  - **Parameter description (not available yet):**
...
# There is currently nothing configurable, but it is still reserved.
[powersave]
